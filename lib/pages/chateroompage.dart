...
import 'package:chat1_practice/Model/MassageModel.dart';
...
class _ChatRoomPageState extends State<ChatRoomPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: SafeArea(
        child: Container(
          color: Color.fromARGB(255, 210, 177, 216),
          child: Column(
            children: [
                        ...
                        if (snapshot.hasData) {
                          ...
                          return ListView.builder(
                            ...
                            itemBuilder: (context, index) {
                              MassageModel currentMessage =
                                  MassageModel.formMap(dataSnapshot.docs[index]
              ...
              Container(
                color: Color.fromARGB(255, 220, 208, 223),
